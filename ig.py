try:
	...
	import requests as r, os, json, time, random	from bs4 import BeautifulSoup as par
...
%s         * %sAuthor%s: %sCandraGanz

%s         * %sGithub%s: %shttps://github.com/FR1END-07

%s         * %sTeam  %s: %sCLAY DARK 07
